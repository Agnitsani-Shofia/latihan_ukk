                ...
                <div class="card-body">
                    ...
                    <?php 
                        ...
                        if ($submit=='Simpan') {
                            ...
                            $deskrpsi_foto=@$_POST['deskripsi_foto'];
                            $nama_file=@$_FILES['namafile']['name'];
                            $tmp_foto=@$_FILES['name']['tmp_name'];
                            $tanggal=date('Y-m-d');
                            $album_id=@$_POST['album_id'];
                            $user_id=@$_SESSION['user_id'];
                            if (move_uploaded_file($tmp_foto, 'uploads/' .$nama_file)) {
                                $insert=mysqli_query($conn, "INSERT INTO foto VALUES ('', '$judul_foto', '$deskrpsi_foto', '$tanggal', '$nama_file', '$album_id', '$user_id' )");
